...
public enum SignatureAlgorithm {
    ...
    RSA_PKCS1_V1_5_WITH_SHA256(
		...
		ContentDigestAlgorithm.CHUNKED_SHA256,
		"RSA",
		Pair.<String,PSSParameterSpec>of("SHA256withRSA", null)),
    ...
    RSA_PKCS1_V1_5_WITH_SHA512(
		...
		ContentDigestAlgorithm.CHUNKED_SHA512,
		"RSA",
		Pair.<String,PSSParameterSpec>of("SHA512withRSA", null)),
    ...
    ECDSA_WITH_SHA256(
		...
		ContentDigestAlgorithm.CHUNKED_SHA256,
		"EC",
		Pair.<String,PSSParameterSpec>of("SHA256withECDSA", null)),
    ...
    ECDSA_WITH_SHA512(
		...
		ContentDigestAlgorithm.CHUNKED_SHA512,
		"EC",
		Pair.<String,PSSParameterSpec>of("SHA512withECDSA", null)),
    ...
    DSA_WITH_SHA256(
		...
		ContentDigestAlgorithm.CHUNKED_SHA256,
		"DSA",
		Pair.<String,PSSParameterSpec>of("SHA256withDSA", null));
