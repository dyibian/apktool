// $ANTLR 3.5.2 smaliParser.g 2017-09-18 19:33:14
...
public class smaliParser extends Parser {
	...
	public final smaliParser.smali_file_return smali_file() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: method, super_spec, implements_spec, field, class_spec, source_spec
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
		...
		try {
			...
			switch (alt5) {
				case 1 :
					...
					// AST REWRITE
					// elements: access_list, literal, annotation, nonvoid_type_descriptor, member_name
					// token labels: 
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
				...
				case 2 :
					...
					// AST REWRITE
					// elements: access_list, literal, nonvoid_type_descriptor, member_name
					// token labels: 
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
	...
	public final smaliParser.method_return method() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: statements_and_directives, member_name, method_prototype, access_list
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final smaliParser.statements_and_directives_return statements_and_directives() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: ordered_method_item, parameter_directive, catchall_directive, registers_directive, catch_directive
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final smaliParser.local_directive_return local_directive() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: NULL_LITERAL, nonvoid_type_descriptor, name, REGISTER, signature
	...
	public final smaliParser.insn_format22b_return insn_format22b() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: REGISTER, integral_literal, INSTRUCTION_FORMAT22b, REGISTER
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final smaliParser.insn_format22s_return insn_format22s() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: integral_literal, REGISTER, instruction_format22s, REGISTER
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final smaliParser.insn_format45cc_method_return insn_format45cc_method() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: method_prototype, method_reference, register_list, INSTRUCTION_FORMAT45cc_METHOD
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
