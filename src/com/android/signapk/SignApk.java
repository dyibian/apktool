...
{
    private static final String CERT_SF_NAME = "META-INF/ANDROID.SF";
    private static final String CERT_SIG_NAME = "META-INF/ANDROID.%s";
	...
	private static void out(String str){
		if(options.verbose)brut.androlib.out1.getout().out(str);
	}
